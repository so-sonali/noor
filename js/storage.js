...
const DB_VERSION=2;
const STORES=['experiments','protocols','syntheses','discussions','plates','calculations','tasks','timers','settings','attachments'];
