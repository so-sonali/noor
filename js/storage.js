...
const DB_VERSION=5;
export const STORES=['experiments','protocols','syntheses','discussions','plates','calculations','tasks','timers','settings','attachments','projects','samples','instruments','literature','decisions','analyses','handwriting','experimentRevisions','auditEvents','syncQueue'];
